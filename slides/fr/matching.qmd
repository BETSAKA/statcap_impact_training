...
## Principe des méthodes d'appariement: Illustration 
...
Pour évaluer l’effet moyen sur les traités (ATT), cela revient à [comparer]{style="color:blue;"} le résultat $Y1$ de chaque unité traitée avec le résultat $Y0$ de l’unité non traitée ayant exactement les mêmes caractéristiques observables.
...
$\Rightarrow$ Pour évaluer l’effet moyen sur les traités (ATT), cela revient à [comparer]{style="color:blue;"} le résultat $Y1$ de chaque unité traitée avec le résultat $Y0$ de l’unité non traitée ayant exactement les mêmes caractéristiques observables.
