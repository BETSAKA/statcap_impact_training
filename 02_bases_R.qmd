...
- Deux bases sur les surfaces de couvert forestier (en ha) d'aires protégées : 
  - Une base d'aire protégées gérées par le gouvernement (MNP)
  - Une base d'aires protégées gérées par des acteurs privés (ONG)
- Une base de régions avec un indicateur agrégé (déforestation)
