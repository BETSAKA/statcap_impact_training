...
2.  **Ajouter des entêtes de colonne colonnes ** : Créez des entêtes qui expliquent le contenu de chaque colonne (par exemple, année de création, superficie annuelle ajoutée, superficie cumulée).
